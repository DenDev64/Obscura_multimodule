...
import com.obscura.llc.moduleproject.utils.Util
...
object UIUtil {
    ...
    fun getOfflineDialog(finishActivity: Boolean): AlertDialog {
        val context = com.obscura.llc.obscuraproject.App.getAppContext()
    ...
    fun getInsecureDeviceDialog() : AlertDialog{
        ...
        return AlertDialog.Builder(
            ...
            .setMessage(context.getString(com.obscura.llc.moduleproject.utils.R.string.root_detection_description))
            .setPositiveButton(
                R.string.settings
            ) { dialog, which ->
